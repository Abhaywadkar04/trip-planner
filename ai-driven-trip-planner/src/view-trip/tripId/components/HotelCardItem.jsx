...
function HotelCardItem({ item, index }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full bg-white rounded-xl shadow-md hover:shadow-xl hover:border-blue-300 border transition-all duration-300 cursor-pointer overflow-hidden">
        {/* Image Container */}
